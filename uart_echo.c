...
main(void)
{
	...
	//unsigned char buf1[20]={'锟?,'锟?};
	Lcd_Init();
	hanzi_Disp(0,0,"武汉大学",8);
	//
	...
	{
		//Lcd_Init();
		hanzi_Disp(0,0,"北京大学武汉大学",16);
		hanzi_Disp(1,0,"北京大学武汉大学",16);
		hanzi_Disp(2,0,"北京大学武汉大学",16);
		hanzi_Disp(3,0,"北京大学武汉大学",17);
		//GPIO_SetBits(GPIOC, GPIO_Pin_13);
		delay(100000);
		hanzi_Disp(0,0,"白日依山尽黄河入海流",16);
		hanzi_Disp(1,0,"欲穷千里目更上一层楼",16);
		hanzi_Disp(2,0,"",16);
		hanzi_Disp(3,0,"北京大学武汉大学",17);
